from connectors.assets.extractor.azure_rest_metadata_extractor import AzureRestConnectorMetadataExtractor
...
connector_metadata_extractor_facade.register(ConnectorTypeProto.AZURE, AzureRestConnectorMetadataExtractor)
