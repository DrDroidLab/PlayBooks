...
from connectors.assets.extractor.mimir_metadata_extractor import MimirConnectorMetadataExtractor
...
connector_metadata_extractor_facade.register(ConnectorTypeProto.GRAFANA_MIMIR, MimirConnectorMetadataExtractor)
