...
from protos.connectors.assets.bash_asset_pb2 import BashSshServerAssetOptions, BashAssetModel, BashSshServerAssetModel, \
    BashAssets
from protos.connectors.connector_pb2 import Connector as ConnectorProto


class BashAssetManager(ConnectorAssetManager):
    ...
    def get_ssh_server_asset_options(ssh_server_assets):
        ...
        options = BashSshServerAssetOptions(ssh_servers=all_servers)
    ...
    def get_ssh_server_asset_values(connector: ConnectorProto, filters: AccountConnectorAssetsModelFilters,
        ...
        options: BashSshServerAssetOptions = filters.ssh_server_model_filters
        ...
        for asset in ssh_server_assets:
            if asset.model_type == SourceModelType.SSH_SERVER:
                rm_asset_protos.append(BashAssetModel(
                    ...
                    ssh_server=BashSshServerAssetModel(name=StringValue(value=asset.model_uid))))
        return AccountConnectorAssets(bash=BashAssets(assets=rm_asset_protos))
