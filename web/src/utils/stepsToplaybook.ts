...
import { Playbook, PlaybookContract, PlaybookContractStep, PlaybookTask, Step } from '../types.ts';
      ...
      task = {
        ...
        metric_task: {
          ...
          grafana_task: {
            ...
            datasource_uid: step.assets.panel_promql_map[0].promql_metrics[0].datasource_uid,
        ...
        case models.NEW_RELIC_ENTITY_APPLICATION:
          new_relic_task = {
            ...
            entity_application_golden_metric_execution_task: {
              ...
              golden_metric_nrql_expression: step.golden_metric?.golden_metric_nrql_expression,
              process_function: 'timeseries'
            }
          };
          break;
