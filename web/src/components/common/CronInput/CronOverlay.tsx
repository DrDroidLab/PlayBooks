  ...
  return (
    <div style={{ zIndex: "200" }}>
      <Overlay close={() => {}} visible={isOpen}>
        <div className="relative bg-white p-4 rounded-lg w-[384px] flex flex-wrap overflow-hidden">
          <div className="flex flex-col gap-4">
            ...
            <Cron
              ...
              clearButtonProps={{
                className:
                  "!bg-violet-500 hover:!text-violet-500 hover:!bg-white border border-violet-500",
              }}
            />
          </div>
          <div
