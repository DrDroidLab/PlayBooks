    ...
    <>
      {stepOutput && (
        <div style={{ marginTop: "5px" }}>
          {out?.data?.task_execution_result?.metric_task_execution_result
            ?.result?.timeseries && (
          ...
          {out?.data?.task_execution_result?.data_fetch_task_execution_result
            ?.result?.table_result?.rows && (
            <PlayBookRunDataTable
              title={"Results"}
              result={
          ...
          {out?.data?.task_execution_result?.action_task_execution_result
            ?.result?.api_response && (
