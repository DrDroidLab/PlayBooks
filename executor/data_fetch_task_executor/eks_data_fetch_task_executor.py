...
from integrations_api_processors.aws_boto_3_api_processor import AWSBoto3ApiProcessor, get_eks_token
...
from protos.playbooks.playbook_pb2 import PlaybookDataFetchTaskDefinition as PlaybookDataFetchTaskDefinitionProto, \
    ...
    PlaybookEksDataFetchTask as PlaybookEksDataFetchTaskProto, PlaybookDataFetchTaskDefinition
...
class EksDataFetchTaskExecutor(PlaybookDataFetchTaskExecutor):
    ...
    def __init__(self, account_id):
        self.source = PlaybookDataFetchTaskDefinitionProto.Source.EKS
        ...
        try:
            eks_connector = Connector.objects.get(account_id=account_id,
                                                  connector_type=ConnectorTypeProto.EKS,
                                                  is_active=True)
        ...
        try:
            ...
            for item in items:
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='NAME'),
                        value=StringValue(value=pod_name)
                    )
                )
                status = item['status']
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='READY'),
                        value=StringValue(value=f"{all_ready_count}/{total_container_count}")
                    )
                )
                phase = status['phase']
                table_columns.append(
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='AGE'),
                        value=StringValue(value=age_str)
                    )
                )
                table_rows.append(
            ...
            return PlaybookDataFetchTaskExecutionResultProto(data_source=PlaybookDataFetchTaskDefinition.Source.EKS,
        ...
        try:
            ...
            for item in items:
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='READY'),
                        value=StringValue(value=f"{ready_replicas}/{spec_replicas}")
                    )
                )
                updated_replicas = status.get('updated_replicas', 0)
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='UP-TO-DATE'),
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='AVAILABLE'),
    ...
    def get_events(self, global_variable_set: Dict, aws_region, cluster_name,
        ...
        try:
            ...
            for event in sorted_events:
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='LAST SEEN'),
                        value=StringValue(value=age_str)
                    )
                )
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        ...
                        value=StringValue(value=event_type)
                    )
                )
                event_reason = event.reason
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='REASON'),
        ...
        try:
            ...
            for service in services.items:
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='TYPE'),
                        value=StringValue(value=service_type)
                    )
                )
                cluster_ip = service.spec.cluster_ip
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='CLUSTER-IP'),
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='EXTERNAL-IP'),
                ...
                table_columns.append(
                    PlaybookDataFetchTaskExecutionResultProto.Result.TableResult.TableColumn(
                        name=StringValue(value='PORT(S)'),
                        value=StringValue(value=ports)
                    )
                )
