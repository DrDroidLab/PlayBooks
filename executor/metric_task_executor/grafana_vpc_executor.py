...
class GrafanaVpcMetricTaskExecutor(PlaybookMetricTaskExecutor):

    def __init__(self, account_id):
        self.source = PlaybookMetricTaskDefinitionProto.Source.GRAFANA_VPC
        ...
        try:
            agent_proxy_connector = Connector.objects.get(account_id=account_id,
                                                          connector_type=ConnectorTypeProto.AGENT_PROXY,
                                                          is_active=True)
