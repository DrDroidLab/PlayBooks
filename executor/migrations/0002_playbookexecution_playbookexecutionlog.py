# Generated by Django 4.1.4 on 2024-04-17 08:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('playbook_task_result_type', models.IntegerField(choices=[(0, 'UNKNOWN'), (1, 'METRIC'), (2, 'DECISION'), (3, 'DATA_FETCH'), (4, 'DOCUMENTATION')])),
