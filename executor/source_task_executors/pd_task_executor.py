...
from protos.playbooks.source_task_definitions.pagerduty_task_pb2 import Pagerduty as PagerDutyTaskProto

logger = logging.getLogger(__name__)


class PdSourceManager(PlaybookSourceManager):

    def __init__(self):
        self.source = Source.PAGER_DUTY
        self.task_proto = PagerDutyTaskProto
        self.task_type_callable_map = {
            PagerDutyTaskProto.TaskType.SEND_NOTE: {
                'task_type': 'SEND_NOTE',
    ...
    def execute_send_note(self, time_range: TimeRange, global_variable_set: Dict, pd_task: PagerDutyTaskProto,
        ...
        try:
            ...
            send_note_task: PagerDutyTaskProto.SendNote = pd_task.send_note
