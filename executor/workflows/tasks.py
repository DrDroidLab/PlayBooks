...
@shared_task
def test_workflow_notification(user_email, account_id, workflow_json, message_type):
    try:
    ...
    try:
        ...
        playbook_execution = create_playbook_execution(account, time_range, playbook_id, playbook_run_uuid, user_email)
