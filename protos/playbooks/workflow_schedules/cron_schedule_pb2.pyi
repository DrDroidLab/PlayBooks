...
class CronSchedule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["duration_in_seconds", b"duration_in_seconds", "rule", b"rule", "timezone", b"timezone"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["duration_in_seconds", b"duration_in_seconds", "rule", b"rule", "timezone", b"timezone"]) -> None: ...
