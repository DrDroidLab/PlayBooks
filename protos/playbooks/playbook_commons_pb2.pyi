...
class PlaybookSourceOptions(google.protobuf.message.Message):
    ...
    class TaskTypeOption(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["display_name", b"display_name", "task_type", b"task_type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["display_name", b"display_name", "supported_model_types", b"supported_model_types", "task_type", b"task_type"]) -> None: ...
