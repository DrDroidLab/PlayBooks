...
class PlaybookTask(google.protobuf.message.Message):
    ...
    class ExecutionConfiguration(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["is_bulk_execution", b"is_bulk_execution"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["is_bulk_execution", b"is_bulk_execution"]) -> None: ...
