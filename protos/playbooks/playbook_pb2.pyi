...
class PlaybookTask(google.protobuf.message.Message):
    ...
    class Configuration(google.protobuf.message.Message):
        ...
        IS_BULK_TASK_FIELD_NUMBER: builtins.int
        @property
        def is_bulk_task(self) -> google.protobuf.wrappers_pb2.BoolValue: ...
        def __init__(
            self,
            *,
            is_bulk_task: google.protobuf.wrappers_pb2.BoolValue | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["is_bulk_task", b"is_bulk_task"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["is_bulk_task", b"is_bulk_task"]) -> None: ...
    ...
    @property
    def configuration(self) -> global___PlaybookTask.Configuration: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        configuration: global___PlaybookTask.Configuration | None = ...,
