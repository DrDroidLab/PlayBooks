...
class PagerDutyIncidentEntryPoint(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["incident_id", b"incident_id", "incident_title", b"incident_title", "service_id", b"service_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["incident_id", b"incident_id", "incident_title", b"incident_title", "service_id", b"service_id"]) -> None: ...
