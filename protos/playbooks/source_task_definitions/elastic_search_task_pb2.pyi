...
class ElasticSearch(google.protobuf.message.Message):
    ...
    class QueryIndex(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["index_name", b"index_name", "query", b"query"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["index_name", b"index_name", "query", b"query"]) -> None: ...
