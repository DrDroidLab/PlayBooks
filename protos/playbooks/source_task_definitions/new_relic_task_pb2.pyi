...
global___EntityApplicationGoldenMetricExecutionTask = EntityApplicationGoldenMetricExecutionTask
...
global___EntityDashboardWidgetNRQLMetricExecutionTask = EntityDashboardWidgetNRQLMetricExecutionTask
...
global___NRQLMetricExecutionTask = NRQLMetricExecutionTask
...
class PlaybookNewRelicTask(google.protobuf.message.Message):
    ...
    @property
    def entity_application_golden_metric_execution_task(self) -> global___EntityApplicationGoldenMetricExecutionTask: ...
    @property
    def entity_dashboard_widget_nrql_metric_execution_task(self) -> global___EntityDashboardWidgetNRQLMetricExecutionTask: ...
    @property
    def nrql_metric_execution_task(self) -> global___NRQLMetricExecutionTask: ...
    def __init__(
        self,
        *,
        type: global___PlaybookNewRelicTask.TaskType.ValueType = ...,
        entity_application_golden_metric_execution_task: global___EntityApplicationGoldenMetricExecutionTask | None = ...,
        entity_dashboard_widget_nrql_metric_execution_task: global___EntityDashboardWidgetNRQLMetricExecutionTask | None = ...,
        nrql_metric_execution_task: global___NRQLMetricExecutionTask | None = ...,
    ) -> None: ...
