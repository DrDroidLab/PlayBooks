...
class Rootly(google.protobuf.message.Message):
    ...
    class SendTimelineEvent(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["content", b"content", "incident", b"incident"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["content", b"content", "incident", b"incident"]) -> None: ...
