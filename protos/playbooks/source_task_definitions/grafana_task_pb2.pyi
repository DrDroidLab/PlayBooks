...
class PromQlMetricExecutionTask(google.protobuf.message.Message):
    ...
    @property
    def promql_label_option_values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PromQlMetricExecutionTask.LabelValue]: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        promql_label_option_values: collections.abc.Iterable[global___PromQlMetricExecutionTask.LabelValue] | None = ...,
...
global___PromQlMetricExecutionTask = PromQlMetricExecutionTask
...
class PlaybookGrafanaTask(google.protobuf.message.Message):
    ...
    @property
    def promql_metric_execution_task(self) -> global___PromQlMetricExecutionTask: ...
    def __init__(
        self,
        *,
        type: global___PlaybookGrafanaTask.TaskType.ValueType = ...,
        datasource_uid: google.protobuf.wrappers_pb2.StringValue | None = ...,
        promql_metric_execution_task: global___PromQlMetricExecutionTask | None = ...,
    ) -> None: ...
