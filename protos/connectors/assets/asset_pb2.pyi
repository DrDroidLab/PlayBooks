...
class ConnectorModelTypeOptions(google.protobuf.message.Message):
    ...
    GCM_LOG_SINK_MODEL_OPTIONS_FIELD_NUMBER: builtins.int
    ...
    @property
    def gcm_log_sink_model_options(self) -> protos.connectors.assets.gcm_asset_pb2.GcmLogSinkAssetOptions: ...
    @property
...
class AccountConnectorAssetsModelFilters(google.protobuf.message.Message):
    ...
    GCM_LOG_SINK_MODEL_FILTERS_FIELD_NUMBER: builtins.int
    ...
    @property
    def gcm_log_sink_model_filters(self) -> protos.connectors.assets.gcm_asset_pb2.GcmLogSinkAssetOptions: ...
    @property
