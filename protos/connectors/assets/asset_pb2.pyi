...
class AccountConnectorAssets(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["assets", b"assets", "azure", b"azure", "clickhouse", b"clickhouse", "cloudwatch", b"cloudwatch", "connector", b"connector", "datadog", b"datadog", "eks", b"eks", "grafana", b"grafana", "new_relic", b"new_relic", "postgres", b"postgres", "remote_server", b"remote_server", "slack", b"slack"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["assets", b"assets", "azure", b"azure", "clickhouse", b"clickhouse", "cloudwatch", b"cloudwatch", "connector", b"connector", "datadog", b"datadog", "eks", b"eks", "grafana", b"grafana", "new_relic", b"new_relic", "postgres", b"postgres", "remote_server", b"remote_server", "slack", b"slack"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["assets", b"assets"]) -> typing_extensions.Literal["cloudwatch", "grafana", "clickhouse", "slack", "new_relic", "datadog", "postgres", "eks", "remote_server", "azure"] | None: ...
