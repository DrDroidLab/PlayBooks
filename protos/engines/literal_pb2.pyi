...
class IdLiteral(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["id", b"id", "long", b"long", "string", b"string"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "long", b"long", "string", b"string", "type", b"type"]) -> None: ...
