...
PLATFORM_PLAYBOOKS_EXECUTION_PAGE_LOCATION = env.str("PLATFORM_PLAYBOOKS_EXECUTION_LOCATION", default='/playbooks/{}?executionId={}')
PLATFORM_WORKFLOWS_EXECUTION_PAGE_LOCATION = env.str("PLATFORM_WORKFLOWS_EXECUTION_LOCATION", default='/workflows/logs/{}')
